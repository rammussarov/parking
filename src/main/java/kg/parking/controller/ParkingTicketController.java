...
public class ParkingTicketController {
    ...
    public ParkingTicketDto bookParkingPlace(@ApiParam(value = "Parking place id that is booked", required = true)
        ...
        try {
            ...
            return new ParkingTicketDto(parkingTicket);
    ...
    public ParkingTicketDto getResultParkingTicket(@ApiParam(value = "Parking ticket id that driver got on entrance", required = true)
        ...
        try {
            ...
            return new ParkingTicketDto(parkingPrice);
